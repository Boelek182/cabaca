...
abstract class AbstractAdapter<ITEM> constructor(protected var itemList: List<ITEM>, private val layoutResId: Int)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        ...
        itemView.setOnClickListener {
            val adapterPositions = viewHolder.adapterPosition
            if (adapterPositions != RecyclerView.NO_POSITION) {
                onItemClick(itemView, adapterPositions)
            }
        }
